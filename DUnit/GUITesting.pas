{ #(@)$Id: GUITesting.pas,v 1.27 2003/01/08 14:33:34 juanco Exp $ }
{: DUnit: An XTreme testing framework for Delphi programs.
   @author  The DUnit Group.
   @version $Revision: 1.27 $ 2001/03/08 uberto
}
(*
...
const
  rcs_id: string = '#(@)$Id: GUITesting.pas,v 1.27 2003/01/08 14:33:34 juanco Exp $';
