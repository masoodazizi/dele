{#(@)$Id: TestFramework.pas,v 1.98 2003/01/08 14:33:35 juanco Exp $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas,v 1.98 2003/01/08 14:33:35 juanco Exp $';
  rcs_verion : string = '$Revision: 1.98 $';
